...
impl<N> PartialEq<N> for IgnoreNum
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
...
impl<N> PartialOrd<N> for IgnoreNum
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
...
impl<N> PartialEq<N> for OnePosNum
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
...
impl<N> PartialOrd<N> for OnePosNum
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
...
pub struct FullRangeNum<N>(PhantomData<N>)
where
	N: FlockRangePNumBeh;

impl<N> FullRangeNum<N>
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
...
impl<N> Default for FullRangeNum<N>
where
	N: FlockRangePNumBeh,
{
	fn default() -> Self {
...
impl<N> FlockRangePNumBeh for FullRangeNum<N>
where
	N: FlockRangePNumBeh,
{
...
impl<N> PartialEq<N> for FullRangeNum<N>
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
...
impl<N> PartialOrd<N> for FullRangeNum<N>
where
	N: FlockRangePNumBeh,
{
	#[inline(always)]
