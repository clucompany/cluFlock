...
pub struct FlockRange<NS, NE, C> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh, C: FlockRangePNumBehChecker {
	start: NS,
	end: NE,
...
impl<NS, NE, C> Debug for FlockRange<NS, NE, C> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh, C: FlockRangePNumBehChecker {
	#[inline]
	fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> Result<(), core::fmt::Error> {
		let core_range = self.clone().into_core();
		
		Debug::fmt(&core_range, f)
	}
}

impl<NS, NE, C> Hash for FlockRange<NS, NE, C> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh, C: FlockRangePNumBehChecker {
	#[inline]
...
impl<N> Default for FlockRangeFull<N> where N: FlockRangePNumBeh {
	#[inline(always)]
	fn default() -> Self {
...
pub enum FlockRangeErr<NS, NE> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh {
	/// scheme: X..max
	InvalidStartPos(NS),
	/// scheme: min..X
	InvalidEndPos(NE),
...
impl<NS, NE> FlockRangeErr<NS, NE> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh {
	/// Make a complete IoError from FlockRangeErr.
	pub fn make_io_error(self) -> IoError {
		let info = match self {
			Self::InvalidStartPos(a) => format!("FlockRangeErr::InvalidStartPos, {:?}..max, unsupported range.", a),
			Self::InvalidEndPos(a) => format!("FlockRangeErr::InvalidEndPos, min..{:?}, unsupported range.", a),
			
			Self::InvalidStartEndPos(a, b) => format!("FlockRangeErr::InvalidStartEndPos, {:?}..{:?}, unsupported range.", a, b),
			Self::InvalidStartEndPos2(a, b) => format!("FlockRangeErr::InvalidStartEndPos, {:?}..{:?}, unsupported range.", a, b),
			Self::InvalidStartEndPos3(a, b) => format!("FlockRangeErr::InvalidStartEndPos, {:?}..{:?}, unsupported range.", a, b),
			
			Self::InvalidShortRange(a) => format!("FlockRangeErr::InvalidShortRange, pos: {:?}, unsupported range.", a),
		};
...
impl<NS, NE> FlockRangeExp<NS, NE> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh {
	/// Disable range checking, any number in the range will not be checked.
	#[inline(always)]
	...
	#[inline]
	pub fn into_check_range(self) -> Result<FlockRangeExpForce<NS, NE>, (FlockRangeExp<NS, NE>, FlockRangeErr<NS, NE>)>  where NE: PartialOrd<NS> {
		self.check_range_fn(
			|| {
				let sself = unsafe {
					self.into_ignore_rangechecker()
				};
				Ok(sself)
			},
			|e| Err((self, e)),
...
impl<NS, NE> From<(NS, NE)> for FlockRangeExp<NS, NE> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh {
	#[inline(always)]
...
impl<N> From<Range<N>> for FlockRangeExp<N, N> where N: FlockRangePNumBeh {
	#[inline(always)]
...
impl<N> From<RangeTo<N>> for FlockRangeEndPos<N> where N: FlockRangePNumBeh {
	#[inline(always)]
...
impl<N> From<RangeFrom<N>> for FlockRangeStartPos<N> where N: FlockRangePNumBeh {
	#[inline(always)]
...
impl<N> From<RangeFull> for FlockRangeFull<N> where N: FlockRangePNumBeh {
	#[inline(always)]
...
impl<NS> From<NS> for FlockRangeOnePos<NS> where NS: FlockRangePNumBeh {
	#[inline(always)]
...
#[inline]
const fn const_new<NS, NE>(start: NS, end: NE) -> FlockRangeExp<NS, NE> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh {
	FlockRange {
		start,
		end,
...
impl<N> FlockRangeFull<N> where N: FlockRangePNumBeh {
...
impl<N> FlockRangeOnePos<N> where N: FlockRangePNumBeh {
	/// 
	#[inline]
...
impl<N> FlockRangeStartPos<N> where N: FlockRangePNumBeh {
...
impl<N> FlockRangeEndPos<N> where N: FlockRangePNumBeh {
...
impl<N> FlockRangeCore<N> where N: FlockRangePNumBeh {
...
impl<NS, NE, C> FlockRange<NS, NE, C> where NS: FlockRangePNumBeh, NE: FlockRangePNumBeh, C: FlockRangePNumBehChecker {
	...
	fn __is_one_pos(&self) -> bool {
		...
		if result {
			debug_assert_eq!(NE::IS_ONEPOS || NE::IS_IGNORE_NUM || NE::IS_FULLRANGE, false);
		}
	...
	fn __is_full_range(&self) -> bool {
		...
		if result {
			debug_assert_eq!(NE::IS_ONEPOS || NE::IS_IGNORE_NUM, true);
		}
	...
	#[inline]
	pub fn is_valid_range(&self) -> bool where NE: PartialOrd<NS> {
		self.check_range_fn(
			|| true,
			|_| false,
		)
	...
	pub fn get(&self) -> (FlockRangePNum, FlockRangePNum) {
		...
		match (NS::IS_IGNORE_NUM, NE::IS_IGNORE_NUM) {
			...
			(false, true) =>	/* A..=max */		(self.start.get_pnum(), NS::get_pnum_max()),
			(true, false) =>	/* min..=A */		(NE::get_pnum_min(), self.end.get_pnum()),
			(false, false) =>	/* A..=B */		(self.start.get_pnum(), self.end.get_pnum())
		}
	}
	
	#[inline]
	pub fn check_range_and_get(&self) -> Result<(FlockRangePNum, FlockRangePNum), FlockRangeErr<NS, NE>> where NE: PartialOrd<NS> {
		self.check_range_and_get_fn(
			|a, b| Ok((a, b)),
			|e| Err(e)
		)
	}
	...
	#[inline]
	pub fn check_range(&self) -> Result<(), FlockRangeErr<NS, NE>> where NE: PartialOrd<NS> {
		self.check_range_fn(
			|| Ok(()),
			|e| Err(e),
		)
	...
	/// Check the range for correctness.
	#[inline]
	pub fn check_range_fn<R>(&self, next: impl FnOnce() -> R, err: impl FnOnce(FlockRangeErr<NS, NE>) -> R) -> R where NE: PartialOrd<NS> {
		match self.is_en_range_check() {
			false => next(),
			true => {
				if self.__is_one_pos() { // onepos
				...
				match (NS::IS_IGNORE_NUM, NE::IS_IGNORE_NUM) {
					...
					(false, true) =>	/* A..=max */		match self.start.is_valid() {
					...
					(true, false) =>	/* min..=A */		match self.end.is_valid() {
					...
					(false, false) =>	/* A..=B */		match self.start.is_valid() {
						true => match self.end.is_valid() {
							true if self.start.is_valid_endrange(self.end) => next(),
							true =>  err(FlockRangeErr::InvalidStartEndPos(self.start, self.end)),
							false => err(FlockRangeErr::InvalidEndPos(self.end)),
						}
						false => err(FlockRangeErr::InvalidStartPos(self.start)),
					}
	...
	#[inline]
	pub fn check_range_and_get_fn<R>(&self, next: impl FnOnce(FlockRangePNum, FlockRangePNum) -> R, err: impl FnOnce(FlockRangeErr<NS, NE>) -> R) -> R where NE: PartialOrd<NS> {
		match self.is_en_range_check() {
			false => {
				if self.__is_one_pos() {
					// onepos
				...
				match (NS::IS_IGNORE_NUM, NE::IS_IGNORE_NUM) {
					...
					(false, true) =>	/* A..=max */		next(self.start.get_pnum(), NS::get_pnum_max()),
					(true, false) =>	/* min..=A */		next(NE::get_pnum_min(), self.end.get_pnum()),
					(false, false) =>	/* A..=B */		next(self.start.get_pnum(), self.end.get_pnum())
				}
			},
			true => {
				if self.__is_one_pos() { // onepos
				...
				match (NS::IS_IGNORE_NUM, NE::IS_IGNORE_NUM) {
					...
					(false, true) =>	/* A..=max */		match self.start.is_valid() {
						true if self.start.is_valid_endrange(NS::MAX) => next(self.start.get_pnum(), NS::get_pnum_max()),
						true => err(FlockRangeErr::InvalidStartEndPos3(self.start, NS::MAX)),
						false => err(FlockRangeErr::InvalidStartPos(self.start)),
					},
					(true, false) =>	/* min..=A */		match self.end.is_valid() {
						true if self.end.is_valid_endrange(NE::MAX) => next(NE::get_pnum_min(), self.end.get_pnum()),
						true => err(FlockRangeErr::InvalidStartEndPos2(NE::MIN, self.end)),
						false => err(FlockRangeErr::InvalidEndPos(self.end)),
					},
					(false, false) =>	/* A..=B */		match self.start.is_valid() {
						true => match self.end.is_valid() {
							true if self.start.is_valid_endrange(self.end) => next(self.start.get_pnum(), self.end.get_pnum()),
							true =>  err(FlockRangeErr::InvalidStartEndPos(self.start, self.end)),
							false => err(FlockRangeErr::InvalidEndPos(self.end)),
						}
						false => err(FlockRangeErr::InvalidStartPos(self.start)),
...
impl<NS, NE, C, NS2, NE2, C2> PartialEq<FlockRange<NS2, NE2, C2>> for FlockRange<NS, NE, C>
	where 
		NS: FlockRangePNumBeh, NE: FlockRangePNumBeh, C: FlockRangePNumBehChecker,
		NS2: FlockRangePNumBeh, NE2: FlockRangePNumBeh, C2: FlockRangePNumBehChecker {
...
fn test_range() {
	...
	crate::__make_auto_pnum_type!(i8);
	
	{ // nums
		assert_eq!((-1i8).is_valid(), false);
		assert_eq!(0i8.is_valid(), true);
		assert_eq!(16i8.is_valid(), true);
		assert_eq!(17i8.is_valid(), false);
	}
	...
	{ // def core range
		{
			...
			assert_eq!(valid_range0.is_en_range_check(), true);
			assert_eq!(valid_range0.is_valid_range(), true);
			
			// 0..10
			let valid_range1 = FlockRange::from((0i8, 10));
			assert_eq!(valid_range1.is_en_range_check(), true);
			assert_eq!(valid_range1.is_valid_range(), true);
			
			assert_eq!(valid_range0 == valid_range1, true);
		}
		
		// 0..max+1
		let invrange0 = FlockRange::from(0..<i8 as FlockRangePNumBeh>::MAX+1);
		assert_eq!(invrange0.is_en_range_check(), true);
		assert_eq!(invrange0.is_valid_range(), false);
	}
	...
	{ // one pos
		{
			...
			assert_eq!(range0.is_en_range_check(), true);
			assert_eq!(range0.is_valid_range(), true);
			
			// pos: 0
			let range1 = FlockRange::new_one_position(0i8);
			assert_eq!(range1.is_en_range_check(), true);
			assert_eq!(range1.is_valid_range(), true);
			
			assert_eq!(range0 == range1, true);
		}
		
		// pos: max+1
		let invrange1 = FlockRange::new_one_position(<i8 as FlockRangePNumBeh>::MAX+1);
		assert_eq!(invrange1.is_en_range_check(), true);
		assert_eq!(invrange1.is_valid_range(), false);
	}
	...
	{ // full
		{
			...
			assert_eq!(range0.get() == (<i8 as FlockRangePNumBeh>::MIN as _, <i8 as FlockRangePNumBeh>::MAX as _), true);
			assert_eq!(range0.is_en_range_check(), false); // FALSE!
			assert_eq!(range0.is_valid_range(), true);
			
			// min..max
			let range1 = FlockRange::new(<i8 as FlockRangePNumBeh>::MIN, <i8 as FlockRangePNumBeh>::MAX);
			assert_eq!(range1.is_en_range_check(), true);
			assert_eq!(range1.is_valid_range(), true);
			...
			assert_eq!(range0 == range3, true);
		}
		
		// max..min
		let invrange1 = FlockRange::new(<i8 as FlockRangePNumBeh>::MAX, <i8 as FlockRangePNumBeh>::MIN);
		assert_eq!(invrange1.is_en_range_check(), true);
		assert_eq!(invrange1.is_valid_range(), false);
	}
	...
	{ // start_range
		...
		// ..10
		let range0 = unsafe {
			range0.into_ignore_rangechecker()
		};
		let (a0, b0) = range0.get();
		assert_eq!(a0, 10i8 as FlockRangePNum);
		assert_eq!(b0, <i8 as FlockRangePNumBeh>::MAX  as FlockRangePNum);
		
		assert_eq!(range0.is_en_range_check(), false);
		assert_eq!(range0.is_valid_range(), true); // todo always true
	}
